        ...
        <div className="grid lg:grid-cols-[2fr_1fr] gap-10">
          ...
          <div>
            ...
            <h1 className="text-[28px] leading-tight font-bold text-[#1f1f1f] max-w-[640px] mb-2 lg:text-[36px] lg:leading-[44px]">
              Certificado Profissional de Gerente de Projetos de TI da IBM
            </h1>

            {/* Descrição */}
            <p className="mt-4 text-[15px] leading-relaxed text-[#373a3c] max-w-[620px] lg:text-[16px] lg:leading-[24px]">
              Inicie sua carreira como gerente de projetos de TI. Prepare-se para
              o trabalho e para o exame de certificação{" "}
              <strong>
      ...
      <div className="relative z-20 -mt-10 lg:-mt-16">
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-6 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <Metric icon={null} title="4.7 ★" subtitle="(1.248 avaliações)" /> {/* Sem ícone na imagem, a estrela está no título */}
            <Metric icon={null} title="Nível Básico" subtitle="Nenhuma experiência prévia necessária" />
